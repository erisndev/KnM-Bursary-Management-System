...
export default function ProfilePage({ userId }) {
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all hover:scale-105"
          >
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="relative flex flex-col gap-4 sm:gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-white rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-2xl flex-shrink-0">
              <User className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-cyan-600" />
            </div>
      ...
      {!canUpdateDocuments && (
        <div className="bg-cyan-50 border-2 border-cyan-200 rounded-2xl p-6 flex items-start space-x-4">
          <AlertCircle className="w-6 h-6 text-cyan-600 flex-shrink-0 mt-0.5" />
          <div>
            <h4 className="font-bold text-cyan-900 mb-1">Application Locked</h4>
      ...
      <InfoCard title="Personal Information" icon={User}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-900 font-semibold">{studentData.fullName}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-500 mb-1 block">ID Number</label>
            <p className="text-gray-900 font-semibold">{studentData.idnumber}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-900 font-semibold capitalize">{studentData.gender}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-500 mb-1 block">Nationality</label>
            <p className="text-gray-900 font-semibold">{studentData.nationality}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-500 mb-1 block">Country</label>
            <p className="text-gray-900 font-semibold capitalize">{studentData.country}</p>
          </div>
        </div>
      </InfoCard>
      ...
      <InfoCard title="Contact Information" icon={Mail}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-900 font-semibold">{studentData.email}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-500 mb-1 block">Phone</label>
            <p className="text-gray-900 font-semibold">{studentData.phone}</p>
          </div>
      ...
      <InfoCard title="Education Information" icon={GraduationCap}>
        <div className="space-y-6">
          <div>
            <h4 className="font-bold text-gray-900 mb-4">High School</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-500 mb-1 block">School Name</label>
                <p className="text-gray-900 font-semibold">{studentData.highSchoolName}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500 mb-1 block">Matric Year</label>
                <p className="text-gray-900 font-semibold">{studentData.highSchoolMatricYear}</p>
              </div>
            </div>
          </div>
          ...
          {studentData.institutionName && (
            <div className="pt-6 border-t border-gray-100">
              <h4 className="font-bold text-gray-900 mb-4">Higher Education</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-gray-500 mb-1 block">Institution</label>
                  <p className="text-gray-900 font-semibold">{studentData.institutionName}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500 mb-1 block">Degree</label>
                  <p className="text-gray-900 font-semibold">{studentData.institutionDegreeName}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500 mb-1 block">Major</label>
                  <p className="text-gray-900 font-semibold">{studentData.institutionMajor}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500 mb-1 block">GPA</label>
                  <p className="text-gray-900 font-semibold">{studentData.institutionGPA}%</p>
                </div>
              </div>
            </div>
          )}
